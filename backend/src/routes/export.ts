...
<title>${deck?.startupName || 'Launchpad Landing'}</title>
...
<p class="text-lg text-gray-400 mb-8 max-w-xl mx-auto">${atlas?.summary || 'Validated by Launchpad — 5 AI agents analyzed this opportunity.'}</p>
