...
export default function LaunchKit() {
  ...
  const deployToVercel = () => {
    if (!kit) return
    const url = `https://vercel.com/new/clone?repository-url=https://github.com/launchpad-demo/launchkit-template&project-name=${encodeURIComponent(kit.tagline.slice(0, 40))}`
      ...
      <div className="shell">
        ...
        {kit && (
          <div className="mt-12 grid lg:grid-cols-2 gap-6">
            {/* Tagline */}
            <BorderGlow backgroundColor="#0C0F15" borderRadius={10} glowRadius={28} glowColor="120 100 50" colors={['#38BDF8', '#34D399', '#A7F3D0']} edgeSensitivity={20}>
              <div className="p-6">
            ...
            <div className="lg:col-span-2">
              <BorderGlow backgroundColor="#0C0F15" borderRadius={10} glowRadius={32} glowColor="120 100 50" colors={['#38BDF8', '#34D399', '#A7F3D0']} edgeSensitivity={20}>
                <div className="p-6">
                  ...
                  <iframe
                    ...
                    style={{ borderColor: 'rgba(56,189,248,0.2)', background: '#000' }}
                  />
                </div>
              </BorderGlow>
            </div>
