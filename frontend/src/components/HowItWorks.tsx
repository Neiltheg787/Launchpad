...
/**
 * "Three Steps to a Fundable Startup Package" with concrete mockups for each step.
 */
const STEP_ACCENTS = {
  '01': {
    chip: '#38BDF8',       // sky blue
    chipBg: 'rgba(56,189,248,0.08)',
    chipBorder: 'rgba(56,189,248,0.40)',
    numeral: 'rgba(56,189,248,0.18)',
    glow: 'rgba(56,189,248,0.30)',
    glowHsl: '120 100 50',
    cardColors: ['#38BDF8', '#34D399', '#A7F3D0'],
  },
  '02': {
    chip: '#34D399',       // emerald
    ...
    glowHsl: '160 84 45',
    cardColors: ['#34D399', '#38BDF8', '#A7F3D0'],
  },
  '03': {
    chip: '#A7F3D0',       // mint
    ...
    <section id="how-it-works" className="relative py-28 md:py-36 overflow-hidden">
      <div
        ...
        style={{
          zIndex: 0,
          background:
            'radial-gradient(circle at 20% 10%, rgba(56,189,248,0.08), transparent 28%), radial-gradient(circle at 80% 45%, rgba(16,185,129,0.08), transparent 32%)',
        }}
      />
        ...
        <div className="p-6 md:p-8 relative">
          ...
          <div className="border-t border-white/5 pt-5">
            ...
            <div className="font-mono text-[15px]" style={{ color: 'rgba(220,255,235,0.85)' }}>
              <span style={{ color: '#38BDF8' }}>&gt;</span> Describe your idea
              <span style={{ color: 'rgba(245,245,240,0.4)' }}>...</span>
            </div>
            {/* Underline */}
            <div className="h-px mt-2" style={{ background: 'rgba(56,189,248,0.35)' }} />

            {/* Fake placeholder lines */}
            <div className="mt-6 space-y-3">
              <div className="h-1.5 rounded-full" style={{ background: 'rgba(56,189,248,0.10)', width: '85%' }} />
              <div className="h-1.5 rounded-full" style={{ background: 'rgba(56,189,248,0.10)', width: '60%' }} />
              <div className="h-1.5 rounded-full" style={{ background: 'rgba(56,189,248,0.10)', width: '70%' }} />
            </div>
          </div>
          ...
          <button
            ...
            style={{
              ...
              boxShadow: '0 16px 40px -16px rgba(56,189,248,0.6)',
            }}
          >
