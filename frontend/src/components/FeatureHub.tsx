      ...
      {phase === 'scored' && result && (
        <div className="text-xs space-y-2">
          <div className="flex justify-between items-baseline">
            ...
            <span className="font-display text-2xl font-bold" style={{ color: result.overallScore >= 60 ? '#38BDF8' : result.overallScore >= 30 ? '#FBBF24' : '#FB7185' }}>
          ...
          {data.alerts?.map((a: any, i: number) => (
            <div key={i} className="flex gap-2 items-start">
              <span
                ...
                style={{
                  background: a.impact === 'negative' ? 'rgba(251,113,133,0.12)' : a.impact === 'positive' ? 'rgba(56,189,248,0.12)' : 'rgba(255,255,255,0.06)',
                  color: a.impact === 'negative' ? '#FB7185' : a.impact === 'positive' ? '#38BDF8' : '#B3ADA2',
                }}
              >
                {a.type}
              </span>
...
function CohortBenchmark({ reportId }: { reportId: string }) {
  ...
  return (
    <Card label="Cohort Benchmarking" desc="See where you rank against other Launchpad founders" state={state} onRun={run} accent="#14B8A6">
      {data && (
        <div className="text-xs space-y-2">
          <div className="flex justify-between">
      ...
      {phase === 'scored' && result && (
        <div className="text-xs space-y-3">
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <div key={d.label} className="text-center">
                ...
                <div className="font-display text-lg font-bold" style={{ color: d.score >= 7 ? '#38BDF8' : d.score >= 5 ? '#FBBF24' : '#FB7185' }}>
                  {d.score}/10
                </div>
              </div>
            ))}
          ...
          <div className="text-center">
            ...
            <div className="font-display text-2xl font-bold" style={{ color: result.overallScore >= 7 ? '#38BDF8' : result.overallScore >= 5 ? '#FBBF24' : '#FB7185' }}>
